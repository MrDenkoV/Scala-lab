...
object Fraction {
  ...
  private class SimplifiableImpl(num: Int, denom: Int)
  extends DefaultImpl(num, denom) with Loggable with Simplifiable {
...
object Appl {
  def main(agrs: Array[String])={
    ...
    val f4 = Fraction(6, 96, simplifiable=true)
    val f5 = Fraction(24, 18, simplifiable=true)

    println(Fraction(1, 6).toString + " + " + Fraction(1, 3).toString + " = " + (Fraction(1, 3, simplifiable=true)+Fraction(1, 6)))
